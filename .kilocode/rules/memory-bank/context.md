...
- [x] **STYLING**: Made WebPhone container slimmer (340px) with more rounded corners (24px)
- [x] **FEATURE**: Auto-configure SIP from ViciDial URL params (phone_login, phone_pass, server_ip, port, protocol)
